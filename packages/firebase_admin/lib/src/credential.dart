...
class Credentials {
  ...
  static void setApplicationDefaultCredential(Credential? credential) {
    _globalAppDefaultCred = credential;
  }
  ...
  static Credential? getApplicationFromServiceAccount(File file) {
    return _credentialFromFile(file.path);
  }
  ...
  static Credential _credentialFromFile(String filePath) {
    ...
    log('seted serviceAccountPath: $serviceAccountPath');
